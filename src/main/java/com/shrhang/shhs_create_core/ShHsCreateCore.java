...
import com.shrhang.shhs_create_core.content.magic.MagicEventHandler;
import com.shrhang.shhs_create_core.content.registries.Fluids;
import com.shrhang.shhs_create_core.content.registries.OpenPipeEffectHandlers;
...
public class ShHsCreateCore {
    ...
    public static void init(final FMLCommonSetupEvent event) {
        event.enqueueWork(OpenPipeEffectHandlers::registerDefaults);
    }
}
